...
void CLevel02::init()
{
	...
	pElli->SetPos(Vec2(480.f, 260.f));
	pElli->SetScale(Vec2(40.f, 40.f));
	AddObject(pElli, LAYER::MONSTER);
	m_MonsterCount++;

	CElli* pElli2 = pElli->Clone();
	pElli2->SetPos(Vec2(80.f, 260.f));
	pElli2->SetScale(Vec2(40.f, 40.f));
	AddObject(pElli2, LAYER::MONSTER);
	m_MonsterCount++;

	CElli* pElli3 = pElli->Clone();
	pElli3->SetPos(Vec2(560.f, 340.f));
	pElli3->SetScale(Vec2(40.f, 40.f));
	AddObject(pElli3, LAYER::MONSTER);
	m_MonsterCount++;

	CElli* pElli4 = pElli->Clone();
	pElli4->SetPos(Vec2(160.f, 340.f));
	pElli4->SetScale(Vec2(40.f, 40.f));
	AddObject(pElli4, LAYER::MONSTER);
	m_MonsterCount++;

	COrange* pOrange1 = new COrange;
	pOrange1->SetPos(Vec2(560.f, 420.f));
	pOrange1->SetScale(Vec2(40.f, 40.f));
	AddObject(pOrange1, LAYER::MONSTER);
	m_MonsterCount++;

	COrange* pOrange2 = pOrange1->Clone();
	pOrange2->SetPos(Vec2(560.f, 180.f));
	pOrange2->SetScale(Vec2(40.f, 40.f));
	AddObject(pOrange2, LAYER::MONSTER);
	m_MonsterCount++;

	COrange* pOrange3 = pOrange1->Clone();
	pOrange3->SetPos(Vec2(320.f, 180.f));
	pOrange3->SetScale(Vec2(40.f, 40.f));
	AddObject(pOrange3, LAYER::MONSTER);
	m_MonsterCount++;

	COrange* pOrange4 = pOrange1->Clone();
	pOrange4->SetPos(Vec2(320.f, 420.f));
	pOrange4->SetScale(Vec2(40.f, 40.f));
	AddObject(pOrange4, LAYER::MONSTER);
	m_MonsterCount++;

	COrange* pOrange5 = pOrange1->Clone();
	pOrange5->SetPos(Vec2(80.f, 420.f));
	pOrange5->SetScale(Vec2(40.f, 40.f));
	AddObject(pOrange5, LAYER::MONSTER);
	m_MonsterCount++;

	COrange* pOrange6 = pOrange1->Clone();
	pOrange6->SetPos(Vec2(80.f, 180.f));
	pOrange6->SetScale(Vec2(40.f, 40.f));
	AddObject(pOrange6, LAYER::MONSTER);
	m_MonsterCount++;
	...
	BGM = CResMgr::GetInst()->FindSound(L"Stage_Forest");
...
void CLevel02::tick()
{
	...
	if (IsTap(KEY::ENTER))
	{
		ChangeLevel(LEVEL_TYPE::LEVEL_03);
	}
...
void CLevel02::LoadTile()
{
	wstring strTilePath = CPathMgr::GetInst()->GetContentPath();
	strTilePath += L"tile\\stage2.tile";
